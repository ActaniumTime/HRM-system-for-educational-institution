    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="deleteEmployerModalLabel" style="color: #ffffff;">Видалення посади</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn bg-danger" id="confirmDeletPosition" style="color: #ffffff;" >Видалити</button>
            </div>
        </div>
    </div>
</div>