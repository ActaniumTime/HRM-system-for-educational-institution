    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="FAQAccreditationModalLabel">FAQ — Система акредитації</h5>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="faq3">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse3">
                                Чи можливо оновоити лише дату/рік документа без повторного завантаження файлу?
                            </button>
                        </h2>
                        <div id="faqCollapse3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Частково. У випадку вточнення точної дати проведення аккредитації - файл не будет потрібно повторно завантажувати.
                                <p>
                                    Але, якщо буде змінен рік проведення аккредитації - файл все ж потрібно буде повторно завантажити.
                                <p>
                                    Нажаль, система не передбачає можливості оновлення року документа без повторного завантаження файлу.
                                </p>
