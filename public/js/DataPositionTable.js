...
function updateTable() {
    const url = '../../models/GetData/getPositionTable.php';
            ...
            data.forEach((position, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="d-flex" style="border-radius: 0px 36px 36px 0px;">
                        <a href="#" class="docViewBtn" data-documentID="${position.documentID}">
                        <button type="button" class="editEmployerBtn" id="docViewBtn"
                            data-position-id="${position.positionID}"
                            data-document-id="${position.documentID}"
                            data-position-name="${position.positionName}"
                            data-position-level="${position.positionLevel}"
                            data-salary="${position.salary}"
                            data-position-requirements="${position.positionRequirements}"
