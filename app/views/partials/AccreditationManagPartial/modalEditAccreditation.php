    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="accreditationModalLabel">Редагування атестації співробітника</h5>
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-3" >
                                                ...
                                                <a href="#" class="btn custom-btn custom-col docViewBtn" data-documentID="" id="docViewBtn">
