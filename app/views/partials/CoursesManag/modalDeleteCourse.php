    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="deleteCourseModalLabel" style="color: #ffffff;">Видалення курсів/стажировки</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>Ви увірені у тому, що бажаєте видалити курси/стажировку?</p>
                <p><strong>ID:</strong> <span id="courseID_deleteForm" name="courseID_deleteForm"></span></p>
                <p><strong>Проходив курси/стажировку: </strong> <span id="employerName_deleteForm" name="employerName_deleteForm"></span></p>
                <p><strong>Назва курсів/стажировки: </strong><span id="courseName_deleteForm" name="courseName_deleteForm"></span></p>
