                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-3" >
                                                ...
                                                <input type="number" class="form-control" id="categoryYearsModal1" name="categoryYearsModal1" min="0" min="5">
                                            </div>
                                            <div class="mb-3 col-md-3" >
                                        ...
                                        <div class="file-attach">
                                            <div class="mb-3 col-md-12" >
                                                ...
                                                <input type="file" class="form-control" id="uploadPDFModal1" name="confirmationFileModal1" accept=".pdf" required >
                                            </div>
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label for="employeeSelect" class="form-label">Назва документу</label>
                                                    <input type="text" class="form-control" id="docNameModal1" name="docNameModal1" placeholder="Постанова про створення позиції..." required>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Ради</label>
                                                    <select class="form-control" id="sphereModal1" name="sphereModal1" required placeholder="Адмінастративна...">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="purposeModal1" name="purposeModal1" placeholder="Наказ про створення нової посади..." required >
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Тип документа</label>
                                                    <select class="form-control" id="docTypeModal1" name="docTypeModal1" required>
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-3" >
                                                <label for="categoryYears" class="form-label">Стаж у катігорії</label>
                                                <input type="number" class="form-control" id="categoryYearsModal2" name="categoryYearsModal2" min="0" min="5">
                                            </div>
                                            <div class="mb-3 col-md-3" >
                                                <label for="categoryYears" class="form-label">Дії</label>
                                                <a href="#" class="docViewBtn" data-documentID="">
                                        ...
                                        <div class="file-attach">
                                            <div class="mb-3 col-md-12" >
                                                <label for="uploadPDF" class="form-label">Додати файл із контрактом</label>
                                                <input type="file" class="form-control" id="uploadPDFModal2" name="confirmationFileModal2" accept=".pdf" required >
                                            </div>
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label for="employeeSelect" class="form-label">Назва документу</label>
                                                    <input type="text" class="form-control" id="docNameModal2" name="docNameModal2" placeholder="Постанова про створення позиції..." required>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Ради</label>
                                                    <select class="form-control" id="sphereModal2" name="sphereModal2" required placeholder="Адмінастративна...">
                                                        <option value="Адмінастративна">Адмінастративна</option>
                                                        <option value="Навчальна">Навчальна</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="currentSalary" class="form-label">Призначення</label>
                                                    <input type="text" class="form-control" id="purposeModal2" name="purposeModal2" placeholder="Наказ про створення нової посади..." required >
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Тип документа</label>
                                                    <select class="form-control" id="docTypeModal2" name="docTypeModal2" required>
                                                        <option value="Сертифікат проходження аккредитації">Сертифікат проходження аккредитації</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-3" >
                                                <label for="categoryYears" class="form-label">Стаж у катігорії</label>
                                                <input type="number" class="form-control" id="categoryYearsModal3" name="categoryYearsModal3" min="0" min="5">
                                            </div>
                                            <div class="mb-3 col-md-3" >
                                                <label for="categoryYears" class="form-label">Дії</label>
                                                <a href="#" class="docViewBtn" data-documentID="">
                                        ...
                                        <div class="file-attach">
                                            <div class="mb-3 col-md-12" >
                                                <label for="uploadPDF" class="form-label">Додати файл із контрактом</label>
                                                <input type="file" class="form-control" id="uploadPDFModal3" name="confirmationFileModal3" accept=".pdf" required >
                                            </div>
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label for="employeeSelect" class="form-label">Назва документу</label>
                                                    <input type="text" class="form-control" id="docNameModal3" name="docNameModal3" placeholder="Постанова про створення позиції..." required>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Ради</label>
                                                    <select class="form-control" id="sphereModal3" name="sphereModal3" required placeholder="Адмінастративна...">
                                                        <option value="Адмінастративна">Адмінастративна</option>
                                                        <option value="Навчальна">Навчальна</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="currentSalary" class="form-label">Призначення</label>
                                                    <input type="text" class="form-control" id="purposeModal3" name="purposeModal3" placeholder="Наказ про створення нової посади..." required >
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Тип документа</label>
                                                    <select class="form-control" id="docTypeModal3" name="docTypeModal3" required>
                                                        <option value="Сертифікат проходження аккредитації">Сертифікат проходження аккредитації</option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-3" >
                                                <label for="categoryYears" class="form-label">Стаж у катігорії</label>
                                                <input type="number" class="form-control" id="categoryYearsModal4" name="categoryYearsModal4" min="0" min="5">
                                            </div>
                                            <div class="mb-3 col-md-3" >
                                        ...
                                        <div class="file-attach">
                                            <div class="mb-3 col-md-12" >
                                                <label for="uploadPDF" class="form-label">Додати файл із контрактом</label>
                                                <input type="file" class="form-control" id="uploadPDFModal4" name="confirmationFileModal4" accept=".pdf" required >
                                            </div>
                                            <div class="row">
                                                <div class="mb-3 col-md-6">
                                                    <label for="employeeSelect" class="form-label">Назва документу</label>
                                                    <input type="text" class="form-control" id="docNameModal4" name="docNameModal4" placeholder="Постанова про створення позиції..." required>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Ради</label>
                                                    <select class="form-control" id="sphereModal4" name="sphereModal4" required placeholder="Адмінастративна...">
                                                        <option value="Адмінастративна">Адмінастративна</option>
                                                        <option value="Навчальна">Навчальна</option>
                                                    </select>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="currentSalary" class="form-label">Призначення</label>
                                                    <input type="text" class="form-control" id="purposeModal4" name="purposeModal4" placeholder="Наказ про створення нової посади..." required >
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="department" class="form-label">Тип документа</label>
                                                    <select class="form-control" id="docTypeModal4" name="docTypeModal4" required>
                                                        <option value="Сертифікат проходження аккредитації">Сертифікат проходження аккредитації</option>
                                                    </select>
                                                </div>
                                            </div>
