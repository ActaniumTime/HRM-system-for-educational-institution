...
function updateTable() {
    const url = '../../models/GetData/getDocumentTable.php';
        ...
        .then(data => {
            ...
            data.forEach((document, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td>${document.sphere}</td>
                    <td>${document.purpose}</td>
                    <td>${document.docType}</td>
                    <td class="d-flex" style="border-radius: 0px 36px 36px 0px;">
                        <a href="#" class="docViewBtn" data-documentID="${document.documentID}">
                        <button type="button" class="editEmployerBtn" id="docViewBtn"
                            data-documentID="${document.documentID}"
                            data-ownerID="${document.ownerID}"
                            data-documentName="${document.documentName}"
                            data-sphere="${document.sphere}"
